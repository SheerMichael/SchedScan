...
const Sidebar = ({ onLogout }) => {
  ...
  const menuItems = [
    ...
    { name: 'Faculty Verification', icon: 'M9 12l2 2 4-4m-8 8h10a2 2 0 002-2V7a2 2 0 00-2-2h-1l-1-2h-4l-1 2H7a2 2 0 00-2 2v9a2 2 0 002 2z', link: '/faculty-verification' },
